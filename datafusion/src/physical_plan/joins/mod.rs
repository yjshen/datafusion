...
fn equal_rows(
    ...
    let res = left_arrays
        ...
        .all(|(l, r)| match l.data_type() {
            DataType::Null => true,
            DataType::Boolean => {
                equal_rows_elem!(BooleanArray, l, r, left, right, allow_nulls)
            }
            DataType::Int8 => equal_rows_elem!(Int8Array, l, r, left, right, allow_nulls),
            DataType::Int16 => {
                equal_rows_elem!(Int16Array, l, r, left, right, allow_nulls)
            }
            DataType::Int32 => {
                equal_rows_elem!(Int32Array, l, r, left, right, allow_nulls)
            }
            DataType::Int64 => {
                equal_rows_elem!(Int64Array, l, r, left, right, allow_nulls)
            }
            DataType::UInt8 => {
                equal_rows_elem!(UInt8Array, l, r, left, right, allow_nulls)
            }
            DataType::UInt16 => {
                equal_rows_elem!(UInt16Array, l, r, left, right, allow_nulls)
            }
            DataType::UInt32 => {
                equal_rows_elem!(UInt32Array, l, r, left, right, allow_nulls)
            }
            DataType::UInt64 => {
                equal_rows_elem!(UInt64Array, l, r, left, right, allow_nulls)
            }
            DataType::Timestamp(_, None) => {
                equal_rows_elem!(Int64Array, l, r, left, right, allow_nulls)
            }
            DataType::Utf8 => {
                equal_rows_elem!(StringArray, l, r, left, right, allow_nulls)
            }
            DataType::LargeUtf8 => {
                equal_rows_elem!(LargeStringArray, l, r, left, right, allow_nulls)
            }
            _ => {
